...
**Alternate path** (if you have a specific problem):
- **Tennis elbow** → DD3 → DD4 (cervical spine referral) → DD6
- **Shoulder impingement** → DD2 → DD1 (kinetic chain) → DD5 (glute med)
- **Lower back pain after tennis** → DD4 → DD5 → DD7 (foot tripod)
